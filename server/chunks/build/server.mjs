import { hasInjectionContext, inject, toRef, version, unref, defineAsyncComponent, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, useSSRContext, getCurrentInstance, isRef, resolveComponent, computed, withCtx, createTextVNode, toDisplayString, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import http from 'node:http';
import https from 'node:https';
import { w as withBase, h as withQuery, l, s, i as hasProtocol, k as isScriptProtocol, m as joinURL, c as createError$1, n as defu, o as sanitizeStatusCode, p as parseQuery, q as parseURL, r as withoutTrailingSlash, t as getContext, v as createHooks, x as getRequestHeaders, y as withTrailingSlash, z as setResponseHeaders, A as toRouteMatcher, B as createRouter$1, C as getQuery, D as cleanDoubleSlashes, E as withoutLeadingSlash } from '../nitro/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import 'node:fs';
import 'node:path';
import 'node:url';
...
const ofetch = createFetch({ fetch, Headers: Headers$1 });
const $fetch = ofetch;
...
const _routes = [
  {
    name: "page",
    path: "/:slug(.*)*",
    component: () => import('./T3Page-D9ZYoZht.mjs')
  }
];
...
const LazyMediaFile = defineAsyncComponent(() => import('./MediaFile-BpdiDXv9.mjs').then((r) => r["default"] || r.default || r));
const LazyMediaAudio = defineAsyncComponent(() => import('./MediaAudio-C2gxHj8r.mjs').then((r) => r["default"] || r.default || r));
const LazyMediaImage = defineAsyncComponent(() => import('./MediaImage-DxbZU2EA.mjs').then((r) => r["default"] || r.default || r));
const LazyMediaVideo = defineAsyncComponent(() => import('./MediaVideo-C-kjUf4Q.mjs').then((r) => r["default"] || r.default || r));
const LazyMediaVimeo = defineAsyncComponent(() => import('./MediaVimeo-D2mmmnkZ.mjs').then((r) => r["default"] || r.default || r));
const LazyMediaYoutube = defineAsyncComponent(() => import('./MediaYoutube--A52FMqe.mjs').then((r) => r["default"] || r.default || r));
const LazyT3BackendLayout = defineAsyncComponent(() => import('./T3BackendLayout-BYZ7DIn2.mjs').then((r) => r["default"] || r.default || r));
const LazyT3BlDefault = defineAsyncComponent(() => import('./T3BlDefault-CjBwn9us.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeBullets = defineAsyncComponent(() => import('./T3CeBullets-DBhrt7PE.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeDefault = defineAsyncComponent(() => import('./T3CeDefault-DFJpDWnv.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeDiv = defineAsyncComponent(() => import('./T3CeDiv-DKQuW6Z8.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeHeader = defineAsyncComponent(() => import('./T3CeHeader-Czpk-uK_.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeHtml = defineAsyncComponent(() => import('./T3CeHtml-kS0RyrMF.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeImage = defineAsyncComponent(() => import('./T3CeImage-BmgL8X7a.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeMenuAbstract = defineAsyncComponent(() => import('./T3CeMenuAbstract-BJMQ9tCP.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeMenuPages = defineAsyncComponent(() => import('./T3CeMenuPages-Cd5LKeFL.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeMenuPagesList = defineAsyncComponent(() => import('./T3CeMenuPagesList-C7UFai7J.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeMenuSitemap = defineAsyncComponent(() => import('./T3CeMenuSitemap-BOsAhxxv.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeMenuSitemapPages = defineAsyncComponent(() => import('./T3CeMenuSitemapPages-BuWIKeym.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeMenuSubpages = defineAsyncComponent(() => import('./T3CeMenuSubpages-D7JxyUhB.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeShortcut = defineAsyncComponent(() => import('./T3CeShortcut-ClnPA6yq.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeTable = defineAsyncComponent(() => import('./T3CeTable-DqINosSf.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeText = defineAsyncComponent(() => import('./T3CeText-CE-mrdir.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeTextmedia = defineAsyncComponent(() => import('./T3CeTextmedia-i46i_D4E.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeTextpic = defineAsyncComponent(() => import('./T3CeTextpic-DbpMcHRg.mjs').then((r) => r["default"] || r.default || r));
const LazyT3CeUploads = defineAsyncComponent(() => import('./T3CeUploads-DOzWOaS-.mjs').then((r) => r["default"] || r.default || r));
const LazyT3Frame = defineAsyncComponent(() => import('./T3Frame-DKUyTOP_.mjs').then((r) => r["default"] || r.default || r));
const LazyT3HtmlParser = defineAsyncComponent(() => import('./T3HtmlParser-CQ9DKlrt.mjs').then((r) => r["default"] || r.default || r));
const LazyT3Link = defineAsyncComponent(() => import('./T3Link-BBeWASBP.mjs').then((r) => r["default"] || r.default || r));
const LazyT3LocaleSwitcher = defineAsyncComponent(() => import('./T3LocaleSwitcher-B9clTdm_.mjs').then((r) => r["default"] || r.default || r));
const LazyT3MediaGallery = defineAsyncComponent(() => import('./T3MediaGallery-9iBzJquo.mjs').then((r) => r["default"] || r.default || r));
const LazyT3Renderer = defineAsyncComponent(() => import('./T3Renderer-AXcfLVVI.mjs').then((r) => r["default"] || r.default || r));
...
const useT3OptionsState = () => {
  const options = useState("T3:Options");
  return options;
};
const useT3Options = () => {
  const options = (/* @__PURE__ */ useRuntimeConfig()).public.typo3;
  ...
  const getSiteOptions = (domain) => {
    ...
    const host = domain || ((_a = useRequestHeaders()) == null ? void 0 : _a.host) || void 0;
...
const useT3PageState = () => {
  const pageState = useState("T3:Page");
  return pageState;
};
const useT3InitialDataState = () => {
  const initialDataState = useState("T3:InitialData");
  return initialDataState;
};
const useT3Api = (path, options) => {
  ...
  const $fetch2 = async (path2 = defaultPath, options2 = defaultOptions) => {
...
const useT3i18nState = () => {
  const i18nState = useState("T3:i18n");
  return i18nState;
};
const useT3i18n = (path) => {
  ...
  const getLocale = (path2) => {
    ...
    const localeCode = slugs == null ? void 0 : slugs.split("/")[1];
    if (i18n.locales && ((_a = i18n.locales) == null ? void 0 : _a.find((locale) => locale === localeCode))) {
      return localeCode;
    }
    return i18n.default;
  };
  ...
  const getCurrentLocaleData = () => {
    ...
    return ((_a = locales.value) == null ? void 0 : _a.find((t3locale) => {
...
class T3ApiClient {
  constructor(siteOptions) {
    __publicField(this, "_$fetch");
    __publicField(this, "initialDataEndpoint");
    __publicField(this, "fetchOptions", {
      headers: {}
    });
    __publicField(this, "apiHeaders");
    __publicField(this, "siteOptions");
  ...
  getOptions(options) {
    return defu(options, {
      onResponse: (context) => {
        ...
        if (Array.isArray((_a = this.siteOptions.api) == null ? void 0 : _a.proxyHeaders) && context.response.headers) {
  ...
  mapResponseHeaders(resHeaders) {
    var _a;
    const proxyHeaders = (_a = this.siteOptions.api) == null ? void 0 : _a.proxyHeaders;
...
async function t3i18nMiddleware(to, from) {
  const { getLocale, setLocale, currentLocale } = useT3i18n(to.fullPath);
  getLocale(to.fullPath);
}
function hasControllerKey(obj) {
...
async function fetchInitialData(to) {
  ...
  const initialDataEndpoint = (_a = currentSiteOptions.value.api.endpoints) == null ? void 0 : _a.initialData;
  const initialDataFallback = (_b = currentSiteOptions.value.api.endpoints) == null ? void 0 : _b.initialDataFallback;
  ...
  try {
    ...
    showError({
      ...
      data: (_c = error.response) == null ? void 0 : _c._data,
      message: `Initial Data is unavailable: ${error.message}`
    });
  }
}
async function t3initialDataMiddleware(to) {
  await callOnce("t3:initialData", async () => await fetchInitialData(to));
}
const plugin_GnmWgXjbFY = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a, _b;
  const { currentSiteOptions } = useT3Options();
  ...
  if ((_a = currentSiteOptions.value.features) == null ? void 0 : _a.initInitialData) {
    addRouteMiddleware("typo3-initialData-middleware", t3initialDataMiddleware, {
      global: true
    });
  }
  if ((_b = currentSiteOptions.value.features) == null ? void 0 : _b.i18nMiddleware) {
...
const hydrateT3ClientHeaders = (client) => {
  useHydration(
    "T3:api:headers",
    () => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const navigation = computed(
      () => {
        var _a, _b, _c;
        return ((_c = (_b = (_a = initialData.value) == null ? void 0 : _a.navigation) == null ? void 0 : _b[0]) == null ? void 0 : _c.children) ?? [];
      }
    );
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      if (unref(navigation)) {
        _push(`<header data-v-7de46968><!--[-->`);
        ssrRenderList(unref(navigation), ({ link, title }) => {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7de46968"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dd8xejAZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D95XV64c.mjs'));
...
export { _export_sfc as _, __nuxt_component_0 as a, asyncDataDefaults as b, createError as c, useT3i18nState as d, entry$1 as default, useT3Options as e, useT3i18n as f, useT3PageState as g, useT3Api as h, useError as i, useRoute as j, injectHead as k, navigateTo as n, resolveUnrefHeadInput as r, showError as s, useNuxtApp as u };
